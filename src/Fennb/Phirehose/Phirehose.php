...
abstract class Phirehose
{
    ...
    const SITE_STREAM_API_URL = 'https://sitestream.twitter.com/1.1/';
    ...
    const USER_STREAM_API_URL = 'https://userstream.twitter.com/2/';
    ...
    public function __construct($username, $password, $method = Phirehose::METHOD_SAMPLE, $format = self::FORMAT_JSON, $lang = FALSE)
    {
        ...
        switch ($method) {
            case self::METHOD_USER:
                $this->URL_BASE = self::USER_STREAM_API_URL;
                break;
            case self::METHOD_SITE:
                $this->URL_BASE = self::SITE_STREAM_API_URL;
                break;
            default:
