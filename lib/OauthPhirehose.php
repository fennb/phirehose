...
abstract class OauthPhirehose extends Phirehose
{
		...
		$oauth_secret = NULL)
	{
		...
		if (!self::$instance instanceof OauthPhirehose)
		{
			self::$instance = new OauthPhirehose(
				$basic_username,
				$basic_password,
				OauthPhirehose::METHOD_USER
			);
		}
	}

	public function __construct($username, $password,
		$method = OauthPhirehose::METHOD_USER,
		$format = self::FORMAT_JSON,
		$auth_method = OauthPhirehose::CONNECT_OAUTH)
	{
	...
	{
		if ($this->auth_method === OauthPhirehose::CONNECT_OAUTH)
		{
			$this->connect_oauth();
		}
		else
